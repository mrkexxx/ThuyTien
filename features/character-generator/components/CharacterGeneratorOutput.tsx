      ...
      <div className="space-y-2">
       ...
       {!isLoading && !error && result?.image && (
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 px-6 bg-gray-700/80 text-white font-semibold rounded-xl shadow-md hover:bg-gray-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-green-500"
