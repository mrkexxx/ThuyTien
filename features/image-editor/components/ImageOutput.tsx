    ...
    <div className="flex flex-col gap-4 p-6 bg-gray-800 rounded-2xl shadow-lg">
      ...
      {!isLoading && !error && result?.image && (
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 px-6 bg-gray-700 text-white font-semibold rounded-xl shadow-md hover:bg-gray-600 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-purple-500"
